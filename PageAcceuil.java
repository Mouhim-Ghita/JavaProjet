...
public class PageAcceuil extends JFrame {
	...
	private void initialize(String nom) {
		...
		btnNewButton.setIcon(new ImageIcon("./images/etudiant.png"));
		btnNewButton.setBounds(371, 114, 221, 188);
		frame.getContentPane().add(btnNewButton);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("./images/coton-rose-uni-oeko-tex.jpg"));
		...
		btnNewButton_1.setIcon(new ImageIcon("./images/prof.jpg"));
		...
		lblNewLabel_4.setIcon(new ImageIcon("./images/beige.jpg"));
